...
THREE.TrackballControls = function ( object, domElement ) {
  ...
  // end code ablaette
    ...
    // document.removeEventListener( 'mousemove', onDocumentMouseMove );
		// document.getElementById("info").innerHTML = "mousedown";
    // end code ablaette
    ...
    // begin code ablaette
    // ocument.addEventListener( 'mousemove', onDocumentMouseMove, false );
    // document.getElementById("info").innerHTML = "mouse up";
    // end code ablaette
...
//        // document.getElementById("info").innerHTML = xCoord + "|" + yCoord;
